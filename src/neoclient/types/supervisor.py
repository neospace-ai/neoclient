...
from neoclient.types import SupervisorChoice
from neoclient.types import Usage

class Supervisor(BaseModel):
    """
    Represents the response from a model after processing a supervisor completion request.
    ...
    Attributes:
        ...
        object (Literal["text_completion"]): The type of object, which is always "supervisor_completion".
